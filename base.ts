...
const cliffnetOptions: Options = {
  ...
  defaultKeyFile: path.join((process.env.HOME != undefined ? process.env.HOME : ""), ".cliffnet.key"),
  fees: {
    upload: 1500000,
    init: 500000,
    exec: 200000,
...
const uniOptions: Options = {
  ...
  hdPath: makeCosmoshubPath(0),
  defaultKeyFile: path.join((process.env.HOME != undefined ? process.env.HOME : ""), ".uni.key"),
  fees: {
    upload: 6000000,
    init: 500000,
    exec: 200000,
