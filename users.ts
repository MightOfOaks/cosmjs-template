export let treasury = {
  ...
  mnemonic:
    "real clarify canoe much tackle quiz jaguar test sad there patrol mixed cost clock crater cabin toilet culture later over pattern innocent reunion sunset",
};
